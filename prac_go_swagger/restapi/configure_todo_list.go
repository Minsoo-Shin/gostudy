...
import (
	...
	"github.com/Minsoo-Shin/go-swagger/restapi/operations"
	"github.com/Minsoo-Shin/go-swagger/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../prac_go_swagger --name TodoList --spec ../swagger.yml --principal interface{}
