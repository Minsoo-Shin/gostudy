...
func (x *Recore) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Recore) ProtoMessage() {}

func (x *Recore) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_log_proto_msgTypes[0]
...
// Deprecated: Use Recore.ProtoReflect.Descriptor instead.
func (*Recore) Descriptor() ([]byte, []int) {
	return file_api_v1_log_proto_rawDescGZIP(), []int{0}
}

func (x *Recore) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Recore) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x72, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20,
	...
	0x2f, 0x6d, 0x69, 0x6e, 0x73, 0x6f, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67, 0x5f,
